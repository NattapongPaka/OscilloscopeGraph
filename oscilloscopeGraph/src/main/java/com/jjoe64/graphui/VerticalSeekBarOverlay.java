...
public class VerticalSeekBarOverlay extends VerticalSeekBar{
	...
	protected synchronized void onDraw(Canvas canvas) {
		...
		paintProgress.setStrokeWidth(3);
		...
		switch(mPosition){
		case LEFT:
			Log.i("LEFT", String.valueOf(getHeight()-progress-THUMB_HEIGHT/2));
			canvas.translate(0, getHeight()-progress-THUMB_HEIGHT/2);
			thumb.draw(canvas);
			break;
			
		case RIGHT:
			Log.i("RIGHT", String.valueOf(getWidth()-THUMB_WIDTH)+":"+String.valueOf(getHeight()-progress-THUMB_HEIGHT/2));
